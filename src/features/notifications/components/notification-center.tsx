...
import { getNotificaciones, marcarLeida, marcarTodasLeidas } from '../api/service';
            ...
            <div className='flex flex-col gap-1 p-2'>
              {visibleNotifications.map((notification) => (
                <NotificationCard
                  ...
                  title={`${accionLabel[notification.accion] ?? notification.accion} en ${notification.entidad}`}
